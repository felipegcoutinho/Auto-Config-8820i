...

        {
          showElement ?
            <div className="commands">
              ...
              <div className='copybutton'><button onClick={() => copyToClip(document.getElementById('foo').innerText)}><i class="fa-solid fa-2x fa-copy"></i></button></div>
            </div>
            :
            <div className="commands">
              <div id='foo1'>
              ...
              <div className='copybutton'><button onClick={() => copyToClip(document.getElementById('foo1').innerText)}><i class="fa-solid fa-2x fa-copy"></i></button></div>
            </div>
        }
      </div>
      {/* UMA VLAN */}
      <div className='umavlan-container'>
        ...
        <div className='cpe-container-uma-vlan'>
          ...
          <div className='testando'>
            ...
            <div className='cpe-modes'><h5 className='AAAA'>ONU 110</h5>
              <label>Modo</label>
              <select value={values.giMode} onChange={handleChange} name="giMode">
                <option value="bridge">bridge</option>
                <option value="router">router</option>
            ...
            <div className='cpe-modes'><h5 className='AAAA'>Default</h5>
              <label>Modo</label>
              <select value={values.defaultMode} onChange={handleChange} name="defaultMode">
                <option value="bridge">bridge</option>
                <option value="router">router</option>
...

        {
          showElement ?
            ...
            <div className="commands">
              <div id='foo4'>
                <p>bridge add <span>{values.uplinkpon1}</span> <span>{values.bridgepon1}</span> vlan <span>{values.vlanpon1}</span> <span>{values.modovlanpon1}</span></p>
                <p>bridge-profile add default downlink vlan <span>{values.vlanpon1}</span> tagged eth 1</p>
                <p>bridge-profile add default-router <span>{bridgeAjustepon1()}</span> vlan <span>{values.vlanpon1}</span> tagged router</p>
